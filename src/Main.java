...
public class Main {
    ...
    private static void printBoardState() {
        System.out.println("Flags: " + game.getFlagCount() + " / " + game.getBombCount());
    ...
    public static void generateGame() {
        ...
        while (!isGenerated) {
            ...
            switch (input) {
                case "Beginner":
                    game.generateBoard(9, 9, 0.1, Game.ShapeOption.RECTANGLE);
                    isGenerated = true;
                    break;
                case "Intermediate":
                    game.generateBoard(16, 16, 0.15, Game.ShapeOption.RECTANGLE);
                    isGenerated = true;
                    break;
                case "Expert":
                    game.generateBoard(30, 16, 0.2, Game.ShapeOption.RECTANGLE);
                    isGenerated = true;
                    break;
                case "Custom":
                    generateCustomGame();
    ...
    public static void generateCustomGame() {
        ...
        Game.ShapeOption chosenShape = null;

        while (chosenShape == null) {
            System.out.println("Choose a shape from the following options:");
            for (Game.ShapeOption option : Game.ShapeOption.values()) {
            ...
            try {
                chosenShape = Game.ShapeOption.valueOf(scanner.nextLine().trim().toUpperCase());
    ...
    public static void regenerateGame() {
        ...
        Game.ShapeOption shape = game.getShape();
    ...
    public static void printCommands() {
        System.out.println("\nTo play type a move in a format - F/C Column Row");
        ...
        System.out.println("stuck      - attempts to flag a bomb near your discovered cells");
